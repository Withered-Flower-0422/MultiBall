...
const COLOR_NODES = [[100, new ColorRGBA(1, 1, 1, 0.75)], [25, new ColorRGBA(1, 1, 1, 0.75)], [20, new ColorRGBA(1, 0xe6 / 255, 0x78 / 255, 0.75)], [15, new ColorRGBA(1, 0x82 / 255, 0x12 / 255, 0.75)], [5, new ColorRGBA(1, 0x4c / 255, 0x28 / 255, 0.75)], [0, new ColorRGBA(1, 0, 0, 0.75)]];
...
export class Avatar {
  ...
  update(enabled, chosen, durability, offset) {
    ...
    imgSub.color = chosen ? new ColorRGBA(1, 1, 1, 0.2) : new ColorRGBA(0, 0, 0, 0.5);
