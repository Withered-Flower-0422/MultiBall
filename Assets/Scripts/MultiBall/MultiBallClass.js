...
export class MultiBall {
  constructor(ballType, templateName, trans, velocity) {
  ...
  switch(ballType, templateName) {
    let trans = arguments.length > 2 && arguments[2] !== undefined ? arguments[2] : this.instance.getTransform();
    let velocity = arguments.length > 3 && arguments[3] !== undefined ? arguments[3] : [this.instance.getComponent("PhysicsObject").getLinearVelocity(), this.instance.getComponent("PhysicsObject").getAngularVelocity()];
    this.ballType = ballType;
